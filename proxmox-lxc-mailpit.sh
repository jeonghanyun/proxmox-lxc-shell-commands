...
add_container_notes() {
    ...
    local notes="MAILPIT EMAIL TESTING SERVER
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
🌐 MAILPIT ACCESS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Web UI:          http://${container_ip}:${MAILPIT_WEB_PORT}
SMTP Server:     ${container_ip}:${MAILPIT_SMTP_PORT}

📧 SMTP CONFIGURATION
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SMTP Host:       ${container_ip}
SMTP Port:       ${MAILPIT_SMTP_PORT}
Authentication:  None required
Encryption:      None (local testing only)

🔧 SERVICE MANAGEMENT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Status:          pct exec ${CT_ID} -- systemctl status mailpit
Start:           pct exec ${CT_ID} -- systemctl start mailpit
Stop:            pct exec ${CT_ID} -- systemctl stop mailpit
Restart:         pct exec ${CT_ID} -- systemctl restart mailpit
Logs:            pct exec ${CT_ID} -- journalctl -u mailpit -f
